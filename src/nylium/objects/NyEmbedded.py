...
class NyEmbedded:
    ...
    def generated_name(cls, owner_uuid: UUID, prop: NyProp) -> str:
    ...
    @classmethod
    def array_element_name(cls, owner_uuid: UUID, prop: NyProp, index: int) -> str:
    ...
    @classmethod
    @Database.commit_after_this
    def _create_child(cls, owner_uuid: UUID, prop: NyProp) -> UUID:
