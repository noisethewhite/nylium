"""WFunction shared vocabulary (ADR-0007/0018): the closed node-kind set,
...
NUMERIC_SCALARS = frozenset({WInteger.TYPE_NAME, WNumeric.TYPE_NAME})
...
def is_numeric_scalar(name: str) -> bool:
    return name in NUMERIC_SCALARS
